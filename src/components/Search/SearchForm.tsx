    ...
    <form onSubmit={onSubmit} className="flex space-x-4">
      <div className="w-full relative">
        <input
          ...
          className="bg-slate-100 p-3 rounded w-full focus-visible:outline-amber-500 text-md h-full dark:bg-slate-200 dark:placeholder:text-slate-500"
          required
        ...
        <div className="absolute right-0 top-0 h-full flex justify-center items-center bg-slate-100 rounded dark:bg-slate-200">
